          ...
          <ul class="navbar-nav ">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink">
                <form action="#" class="p-4 border rounded col-12 dropdown-item" id="login">
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                      <a href="usuarioIndex.html"><input type="button" value="Iniciar Sesión"
                          class="btn px-4 btn-primary text-white"></a>
                    </div>
                  </div>
                </form>
              </div>
              ...
              <div class="registro-usuario-home" id="registro-usuario" style="display:none;">
                <div class="col-lg-12 mb-5 ">
                  ...
                  <form action="" method="post" enctype='multipart/form-data' class="p-4 border rounded formContainer">
                    ...
                    <fieldset class="form-group mb-4">
                      ...
                      <div class="row form-group">
                        <div class="col-md-6 mb-3 mb-md-0">
                          <input type="text" id="userForm" class="form-control" placeholder="Nombre(s)">
                        </div>
                        <div class="col-md-6 mb-3 mb-md-0">
                          <input type="text" id="userForm" class="form-control" placeholder="Apellido paterno">
                        </div>
                      ...
                      <div class="row form-group ">
                        ...
                        <div class="col-md-6 mb-3 mb-md-0">
                          <input type="text" id="userForm" class="form-control" placeholder="Dirección de E-mail"
                            require>
                        </div>
                        <div class="col-md-6 mb-3 mb-md-0">
                    ...
                    <!-- Recaptcha-->
                    <div class="row form-group ">
                      <div class="g-recaptcha col-6" data-sitekey="6Lc2d-sUAAAAAKv9FnOZWkCeXJ2iZjqnCRsbFE6G">
                    ...
                    <div class="row form-group justify-content-end">
                      <div class="col-md-12">
                        <a href="usuarioIndex.html"><input type="button" value="Registrarse"
                            class="btn px-4 btn-primary text-white"> </a>
                      </div>
